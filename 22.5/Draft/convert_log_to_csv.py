...
def build_summary_dataframe(df, window_seconds):
    ...
    summary["effective_window_duration"] = (summary["time_from_zero_max"] - summary["time_from_zero_min"]).clip(lower=1e-9)
    summary["rx_mbps_observed"] = summary["rx_bytes_sum"] * 8 / summary["effective_window_duration"] / 1_000_000
    summary["tx_mbps_observed"] = summary["tx_bytes_sum"] * 8 / summary["effective_window_duration"] / 1_000_000
